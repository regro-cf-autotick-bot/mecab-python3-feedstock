...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/mecab-python3-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mecab-python3-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11848&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mecab-python3-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.15.____cp315" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add mecab-python3
# for installing globally
pixi global install mecab-python3
```
...
It is possible to list all of the versions of `mecab-python3` available on your platform:
...
```
pixi search mecab-python3 --channel conda-forge
```
